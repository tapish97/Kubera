    ...
    <AppShell>
        ...
        <section aria-labelledby="actions-heading" className="px-5 pt-8">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            ...
            <button type="button" className="flex min-h-24 flex-col justify-between rounded-[22px] bg-[#f1bb5d] p-4 text-left text-[#4e350d]"><DashboardIcon name="sale" className="h-6 w-6" /><span><span className="block font-bold">{t("recordSale")}</span><span className="mt-0.5 block text-xs text-[#6d501e]">{t("recordSaleHint")}</span></span></button>
            <button type="button" className="flex min-h-24 flex-col justify-between rounded-[22px] border border-[#e7e1d5] bg-white p-4 text-left"><DashboardIcon name="inventory" className="h-6 w-6 text-[#216148]" /><span><span className="block font-bold">{t("inventoryAction")}</span><span className="mt-0.5 block text-xs text-[#777b73]">{t("inventoryHint")}</span></span></button>
          </div>
        </section>

        <section aria-labelledby="recent-heading" className="px-5 pt-8">
          <div className="flex items-center justify-between"><h2 id="recent-heading" className="text-lg font-semibold tracking-tight">{t("recentSales")}</h2><button type="button" className="flex items-center gap-1 text-xs font-bold text-[#216148]">{t("viewAll")} <DashboardIcon name="arrow" className="h-4 w-4" /></button></div>
